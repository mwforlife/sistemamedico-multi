...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Nacionalidad</title>
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Registro de Nacionalidad</h1>
							<ol class="breadcrumb">
						...
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									...
									<form id="nacionalidadesform" name="nacionalidadesform" class="needs-validation was-validated">
										<div class="row">
											<div class="col-lg-6">
											...
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Nombre</label>
													<input class="form-control" id="Nombre" name="Nombre" placeholder="Nombre Nacionalidad" required="" type="text" value="">
												</div>
											</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado Nacionalidades</h4>
								</div>
								<div class="card-body">
									<div class="">
												...
												<tbody class="text-center">
													<?php
														...
														foreach ($lista as $row) {
															...
															echo "<a href='#' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#modaledit' onclick='cargarNacionalidades(".$row->getId().")'><i class='fa fa-edit'></i></a>";
															echo "<a href='#' class='btn btn-danger btn-sm' onclick='EliminarNacionalidades(".$row->getId().")'><i class='fas fa-trash-alt'></i></a>";
															echo "</td>";
															echo "</tr>";
														}
													?>
