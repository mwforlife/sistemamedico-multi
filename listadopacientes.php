...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Listado Pacientes</title>
                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Pacientes</h1>
                            <ol class="breadcrumb">
                                            ...
                                            <table class="table w-100 text-nowrap" id="example1">
                                                <thead class="border-top">
                                                    <tr class="text-center">
                                                        <th class="bg-transparent">Identificacion</th>
                                                        <th class="bg-transparent">Nombre</th>
                                                        <th class="bg-transparent">Apellidos</th>
                                                        <th class="bg-transparent">Nombre Social</th>
                                                        <th class="bg-transparent">Fecha Nacimiento</th>
                                                        <th class="bg-transparent">Edad</th>
                                                        <th class="bg-transparent">Fono Movil</th>
                                                        <th class="bg-transparent">Correo Electronico</th>
                                                        <th class="bg-transparent text-center">Ficha</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    ...
                                                    foreach ($lista as $r) {
                                                        ...
                                                        if ($r->getTipoidentificacion() == 1) {
                                                            echo "<td>" . $r->getRut() . "</td>";
                                                        } else if ($r->getTipoidentificacion() == 2) {
                                                            echo "<td>Sin Registro</td>";
                                                        } else if ($r->getTipoidentificacion() == 3 || $r->getTipoidentificacion() == 4) {
                                                            echo "<td>" . $r->getIdentificacion() . "</td>";
                                                        }
                                                        echo "<td>" . $r->getNombre() . "</td>";
                                                        echo "<td>" . $r->getApellido1() . " " . $r->getApellido2() . "</td>";
                                                        if ($r->getNombresocial() == "") {
                                                            echo "<td> Sin Registro </td>";
                                                        }else{
                                                            echo "<td>" . $r->getNombresocial() . "</td>";
                                                        }
                                                        ...
                                                        echo "<td>" . $dia . " de " . $mestexto . " de " . $ano . "</td>";
