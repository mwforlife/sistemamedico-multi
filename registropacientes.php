														...
														<div class="row">
															...
															<div class="col-lg-3">
																<div class="form-group has-success mg-b-0">
																	...
																	<input id="discapacidad" name="discapacidad" type="checkbox" value="1" onclick="checkdiscapacidad()">
																</div>
															</div>
															<!--¿Discapacidad?-->
															<div class="col-lg-6 discapacidad d-none">
																<div class="form-group has-success mg-b-0">
																	<label>Descripción Discapacidad</label>
																	<input class="form-control" id="descripciondiscapacidad" name="descripciondiscapacidad" placeholder="Descripción Discapacidad"  type="text" value="">
																</div>
															</div>
														</div>
														<div class="row">
