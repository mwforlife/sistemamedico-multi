...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Especialidad</title>
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Registro de Especialidad</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div>
										<h6 class="main-content-label mb-1">Registro de Especialidad</h6>
										<p class="text-mutted card-sub-title"></p>
									</div>
									<form id="especialidadform" name="especialidadform" class="needs-validation was-validated">
										<div class="row">
											<div class="col-lg-6">
											...
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Nombre</label>
													<input class="form-control" id="Nombre" name="Nombre" placeholder="Nombre Especialidad" required="" type="text" value="">
												</div>
											</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado De Especialidad</h4>
								</div>
								<div class="card-body">
									<div class="">
														...
														foreach ($lista as $object) {
															echo "<tr>
																		...
																		<td class='text-center'>
																			<a href='javascript:void(0)' class='btn btn-sm btn-primary' data-toggle='modal' data-target='#modaledit' onclick='cargarEspecialidad(" . $object->getId() . ")'><i class='fa fa-edit'></i></a>
																			<a href='javascript:void(0)' class='btn btn-sm btn-danger' onclick='EliminarEspecialidad(" . $object->getId() . ")'><i class='fas fa-trash-alt'></i></a>
																		</td>
																	</tr>";
														}
													}
