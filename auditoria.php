		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				<div class="inner-body">
					...
					<div class="row">									
						<?php
							$list = $c->listarAcciones();
							foreach($list as $r){
								echo "<a class='col-xl-4 col-md-4 col-lg-4 ' href='auditar1.php?code=".$r->getId()."'>";
									echo "<div class='card'>";
										echo "<div class='card-body btn btn-outline-success'>";
											echo "<div class='d-flex no-block align-items-center'>";
												echo "<div class='text-left'>";
													echo "<p class='mb-1 text-dark fs-20 font-weight-medium'>".$r->getNombre()."</p>";
												echo "</div>";
												echo "<div class='ml-auto'>";
													echo "<span class='bg-warning icon-service-2 text-white '>";
                                    ...
                                    <table class="table w-100 text-nowrap" id="example1">
                                        <thead class="border-top">
                                            <tr class="text-center">
                                                ...
                                                <th class="bg-transparent text-center">Auditar</th>
                                            </tr>
                                        </thead>
                                        <tbody>
											<?php
												...
												foreach($lista as $r){
													...
													echo "<td class='text-center'>";
														echo "<a href='auditar.php?user=".$r->getId()."' class='btn btn-outline-success' title='Activar Usuario'><i class='fa fa-eye'></i></a>";
