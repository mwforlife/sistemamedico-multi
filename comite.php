...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Registro de Comité</title>
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Registro de Comité</h1>
							<ol class="breadcrumb">
							...
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div class="d-flex justify-content-between">
										<h6 class="main-content-label mb-1">Registro de Comité</h6>
										<h6 style="font-size:20px; border:1px solid; padding:7px; width:200px; border-radius:10px;" class="main-content-label card-sub-title folio">Folio:</h6>
									</div>
									<form id="comiteform" name="comiteform" class="needs-validation was-validated">
										<div class="row">
											<div class="col-lg-4">
											...
											<div class="col-lg-8">
												<div class="form-group has-success mg-b-0">
													...
													<div class="row">
														<div class="col-md-9">
															<input type="text" readonly class="form-control" id="nombretext">
															<input type="hidden" id="idnombre" name="idnombre" value="">
											...
											<div class="col-md-12 mt-3 text-right">
												...
												<button id="btnregistrar" type="submit" href="#" class="btn btn-primary btn-md"> <i class="fa fa-save"></i> Registrar</button>
											</div>
										</div>
									</form>
								</div>
					...
					<div class="row d-none comitedetails">
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									...
									<input type="hidden" id="idcomite" name="idcomite" value="">
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group has-success mg-b-0">
					...
					<div class="row d-none comitedetails">
						<div class="col-md-12 mt-3 text-right">
							<button type="submit" href="#" class="btn btn-success btn-md mr-2" onclick="finalizarcomite()"> <i class="fa fa-save"></i> Guardar</button>
						</div>
					</div>
