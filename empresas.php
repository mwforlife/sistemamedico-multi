				...
				<div class="inner-body">
					...
					<div class="row">
						<div class="col-md-12 text-right mb-2">
							<a href="registrarempresa.php" class="btn btn-md btn-success">Nueva Empresa <i
											...
											<table class="table text-nowrap w-100" id="example1">
												...
												<tbody>
													...
													foreach ($lista as $object) {
														$id = $c->encrypt($object->getId(),"thechallengeofcoding");
														...
														echo "</i>";
														echo "</a>";
														echo "<a href='Editarempresa.php?code=" . $id . "' class='btn btn-outline-warning mr-2 btn-sm rounded-11' data-toggle='tooltip' data-original-title='Edit'><i class='fa fa-pen'></i></a>";
