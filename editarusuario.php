...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Editar Usuario</title>
			...
			<div class="container-fluid">
				<div class="inner-body">
					...
					<div class="card">
						...
						<div class="card-body">
						<form name="usuarioformedit" id="usuarioformedit" class="needs-validation was-validated">
								<input name="id" id="id" type="hidden" required value="<?php echo $usuario->getId();?>">
								<div class="row">
									<div class="col-md-6 col-lg-6 ">
										<div class="form-group has-success mg-b-0">
											<label for="">RUT</label>
											<input name="UserRut" maxlength="12" minlength="9" autocapitalize="true" id="UserRut" value="<?php echo $usuario->getRut();?>" type="text" onkeyup="formatRut(this)" placeholder="11.111.111-1" required class="form-control">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Nombres</label> 
											<input type="text" autocapitalize="true" autocomplete="false" name="UserNombre" id="UserNombre" value="<?php echo $usuario->getNombre();?>" class="form-control" required placeholder="Ingrese el Nombre">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Apellido1</label>
											<input type="text" autocapitalize="true" autocomplete="false" class="form-control" name="UserApellido1" value="<?php echo $usuario->getApellido1();?>" id="UserApellido1" required placeholder="Ingrese Primer Apellido">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Apellido2</label>
											<input type="text" autocapitalize="true" autocomplete="false" class="form-control" name="UserApellido2" id="UserApellido2" value="<?php echo $usuario->getApellido2();?>" placeholder="Ingrese su Segundo">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Correo Electronico</label>
											<input type="email" autocapitalize="true" autocomplete="false" class="form-control" name="UserEmail" id="UserEmail" value="<?php echo $usuario->getEmail();?>" required placeholder="Ingrese el Correo Electronico">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Dirección</label>
											<input type="text" autocapitalize="true" autocomplete="false" class="form-control" name="UserDireccion" value="<?php echo $usuario->getDireccion();?>" id="UserDireccion" required placeholder="Ingrese su Direccion">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											...
											<select name="UserRegion" autocapitalize="true" id="UserRegion" onchange="listadocomunaregion(this)" required class="form-control regiones select2">
												...
												foreach ($lista as $object) {
													if($usuario->getRegion() == $object->getId()){
									...
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											...
											<select name="UserComuna" autocapitalize="true" required id="UserComuna" class="form-control comunas select2">
												<?php
												$lista = $c->listarcomuna($usuario->getRegion());
												foreach ($lista as $object) {
													if($usuario->getComuna() == $object->getId()){
														echo "<option value='" . $object->getId() . "' selected>" . $object->getNombre() . "</option>";
													}else{
														echo "<option value='" . $object->getId() . "'>" . $object->getNombre() . "</option>";
													}
									...
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											...
											<select name="Userprofesion" autocapitalize="true" required id="Userprofesion" class="form-control select2">
												...
												foreach ($lista as $object) {
													if($usuario->getProfesion() == $object->getId()){
														echo "<option value='" . $object->getId() . "' selected>" . $object->getNombre() . "</option>";
													}else{
														echo "<option value='" . $object->getId() . "'>" . $object->getNombre() . "</option>";
													}
									...
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											...
											<select name="UserServicio" autocapitalize="true" required id="UserServicio" class="form-control select2">
												...
												foreach ($lista as $object) {
													if($usuario->getProveniencia() == $object->getId()){
														echo "<option value='" . $object->getId() . "' selected>" . $object->getNombre() . "</option>";
													}else{
														echo "<option value='" . $object->getId() . "'>" . $object->getNombre() . "</option>";
													}
									...
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											...
											<input type="text" autocapitalize="true" autocomplete="false" class="form-control" required name="UserPhone" value="<?php echo $usuario->getTelefono();?>" id="UserPhone" placeholder="Ingrese su numero de telefono">
										</div>
									</div>
