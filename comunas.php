...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Registro de Comunas</title>
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Registro de Comuna</h1>
							<ol class="breadcrumb">
						...
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									...
									<form id="comunasform" name="comunasform" class="needs-validation was-validated">
										<div class="row">
											<div class="col-lg-6">
											...
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													...
													<select class="form-control select2" id="Provincia" name="Provincia" required="">
													<?php
														...
														foreach ($lista as $object) {
															echo "<tr>
																		...
																		<td class='text-center'>
																			<a href='javascript:void(0)' class='btn btn-sm btn-primary' data-toggle='modal' data-target='#modaledit' onclick='cargarComunas(" . $object->getId() . ")'><i class='fa fa-edit'></i></a>
																			<a href='javascript:void(0)' class='btn btn-sm btn-danger' onclick='EliminarComunas(" . $object->getId() . ")'><i class='fas fa-trash-alt'></i></a>
																		</td>
															</tr>";
														}
													}
