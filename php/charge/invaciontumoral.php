...
if (isset($_POST['id'])) {
	$id = $_POST['id'];
	$object = $c->buscareninvaciontumoral($id);
	if ($object != null) {
		echo "<div class='row'>";
		...
		echo "<button type='button' class='btn btn-primary' onclick='actualizarInvacionTumoral(" . $object->getId() . ")'><i class='fas fa-save'></i> Guardar Cambios</button>";
