...
if (isset($_POST['id'])) {
	...
	if ($object != null) {
		...
		echo "<button type='button' class='btn btn-primary' onclick='actualizarGeneros(" . $object->getId() . ")'><i class='fas fa-save'></i> Guardar Cambios</button>";
