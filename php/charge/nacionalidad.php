...
if (isset($_POST['id'])) {
	$id = $_POST['id'];
	$object = $c->buscarenNacionalidad($id);
	if ($object != null) {
		echo "<div class='row'>";
		...
		echo "<button type='button' class='btn btn-primary' onclick='actualizarNacionalidades(" . $object->getId() . ")'><i class='fas fa-save'></i> Guardar Cambios</button>";
