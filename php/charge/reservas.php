            ...
            <table class="table w-100 text-wrap text-center" id="example1">
                ...
                <tbody>';
                    foreach ($lista as $l) {
                        ...
                        $contenido .= "<td class='bg-transparent'>" . $horainicio . " - " . $horatermino . "</td>";
                        ...
                        if ($estado == 1) {
                            //Reservado
                            $contenido .= "<td class='bg-transparent'><span class='badge badge-success'>$estadonombre</span></td>";
                            ...
                            //Confirmado
                            $contenido .= "<td class='bg-transparent'><span class='badge badge-primary'>$estadonombre</span></td>";
                            $contenido .= "<td class='bg-transparent'>";
                            if(strlen($horallegada) == 8){
                                $contenido .= date("H:i", strtotime($horallegada));
                            }
                            ...
                            //En Sala de Espera
                            $contenido .= "<td class='bg-transparent'><span class='badge badge-warning'>$estadonombre</span></td>";
                            $contenido .= "<td class='bg-transparent'>";
                            if(strlen($horallegada) == 8){
                                $contenido .= date("H:i", strtotime($horallegada));
                            }
                            ...
                            //En Atención
                            $contenido .= "<td class='bg-transparent'><span class='badge badge-info'>$estadonombre</span></td>";
                            $contenido .= "<td class='bg-transparent'>";
                            if(strlen($horallegada) == 8){
                                $contenido .= date("H:i", strtotime($horallegada));
                            }
