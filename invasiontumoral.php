...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Invasión Tumoral</title>
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Registro de Invasion Tumoral</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div>
										<h6 class="main-content-label mb-1">Registro de Invasion Tumoral</h6>
										<p class="text-mutted card-sub-title"></p>
									</div>
									<form id="invaciontumoralform" name="invaciontumoralform" class="needs-validation was-validated">
										<div class="row">
											<div class="col-lg-6">
											...
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Nombre</label>
													<input class="form-control" id="Nombre" name="Nombre" placeholder="Nombre Invasión Tumoral" required="" type="text" value="">
												</div>
											</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado de Invacion Tumoral</h4>
								</div>
								<div class="card-body">
									<div class="">
										<div class="table-responsive">
											<table class="table w-100 text-nowrap" id="example1">
												...
												<tbody class="text-center">
													<?php
														$lista = $c->listarinvaciontumoral();
														foreach ($lista as $row) {
															echo "<tr>";
															echo "<td>".$row->getCodigo()."</td>";
															echo "<td>".$row->getNombre()."</td>";
															echo "<td class='text-center'>";
															echo "<a href='#' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#modaledit' onclick='cargarInvacionTumoral(".$row->getId().")'><i class='fa fa-edit'></i></a>";
															echo "<a href='#' class='btn btn-danger btn-sm' onclick='EliminarInvacionTumoral(".$row->getId().")'><i class='fas fa-trash-alt'></i></a>";
															echo "</td>";
															echo "</tr>";
														}
													?>
