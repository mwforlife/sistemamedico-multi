...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Provincias</title>
						...
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									...
									<form id="provinciaform" name="provinciaform" class="needs-validation was-validated">
										<div class="row">
											<div class="col-lg-6">
														...
														foreach ($lista as $object) {
															echo "<tr>
																		...
																		<td class='text-center'>
																			<a href='javascript:void(0)' class='btn btn-sm btn-primary' data-toggle='modal' data-target='#modaledit' onclick='cargarProvincia(" . $object->getId() . ")'><i class='fa fa-edit'></i></a>
																			<a href='javascript:void(0)' class='btn btn-sm btn-danger' onclick='EliminarProvincia(" . $object->getId() . ")'><i class='fas fa-trash-alt'></i></a>
																		</td>
															</tr>";
														}
													}
