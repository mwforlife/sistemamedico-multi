$(function() {
	...
	// ______________ theme-style
	
	// $('body').addClass('theme-style');
	
	// ______________ boxed
	
	// $('body').addClass('boxed');

	
	// ______________ color-leftmenu
	...
	// ______________ color-header
	
	// $('body').addClass('color-header');

	// ______________ dark-theme
	
	// $('body').addClass('dark-theme');

	// ______________ light-theme
	
	// $('body').addClass('light-theme');

	// ______________ color-horizontal
	
	// $('body').addClass('color-horizontal');

	// ______________ light-horizontal
