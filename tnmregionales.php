										...
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													...
													<input class="form-control" id="Nombre" name="Nombre"
														placeholder="Ejemplo: Ne" required="" type="text" value="">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select class="form-control select2" name="diagnostico"
														id="diagnostico" required="">
														<?php
											...
											<div class="col-md-12 mt-3 text-right">
												<button type="reset" href="#" class="btn btn-warning btn-md"> <i
														class="fa fa-refresh"></i> Restablecer</button>
												<button type="submit" href="#" class="btn btn-primary btn-md"> <i
						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado de TNM-Regionales Clinico
									</h4>
								</div>
								<div class="card-body">
									<div class="">
