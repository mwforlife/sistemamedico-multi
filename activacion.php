...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Activacion de Usuarios</title>
				...
				<div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Activar Usuarios</h1>
                            <ol class="breadcrumb">
                                        ...
                                        <tbody>
											<?php
												...
												foreach($lista as $r){
													...
													if($r->getEstado()==1){
														echo "<a href='javascript:void(0)' onclick='activar(".$r->getId().",".$r->getEstado().")' class='btn btn-outline-success' title='Desactivar Usuario'><i class='fa fa-check'></i></a>";
													}else{
														echo "<a href='javascript:void(0)' onclick='activar(".$r->getId().",".$r->getEstado().")' class='btn btn-outline-danger' title='Activar Usuario'><i class='fa fa-times'></i></a>";
													}
													echo "</td>";
													echo "</tr>";
												}
