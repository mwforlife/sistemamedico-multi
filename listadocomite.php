...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Listado Comité</title>
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Listado de Comité</h1>
							<ol class="breadcrumb">
                    ...
                    <div class="row mb-3">
                        ...
                        <a href="comite.php" class="btn btn-success">Crear Comité <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado de Comité Iniciados</h4>
								</div>
								<div class="card-body">
									<div class="">
											...
											<table class="table w-100 text-nowrap" id="example1">
												<thead class="border-top text-center">
													<tr>
														...
														<th class="bg-transparent">Evaluación Paciente</th>
												...
												<tbody class="text-center">
													<?php
														...
														foreach($lista as $fila){
															...
															echo "<td><a href='registrarcomite.php?code=".$id."' class='btn btn-outline-success'><i class='fa fa-user-plus'></i></a></td>";
															echo "<td>";
															echo "<a href='editarcomite.php?code=".$id."' class='btn btn-outline-warning m-1' ><i class='fa fa-edit'></i></button>";
															echo "</td>";
															echo "</tr>";
														}
													?>
                    ...
                    <div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado de Comité Finalizados</h4>
								</div>
								<div class="card-body">
									<div class="">
										<div class="table-responsive">
											<table class="table w-100 text-nowrap" id="example2">
												<thead class="border-top text-center">
													<tr>
														...
														<th class="bg-transparent">Fecha</th>
														<th class="bg-transparent">Nombre</th>
														<th class="bg-transparent text-center">Habilitar</th>
													</tr>
												</thead>
												<tbody class="text-center"><?php
														$lista = $c->listarcomitevaloresinactivo($empresa->getId());
														foreach($lista as $fila){
															echo "<tr>";
															echo "<td>".$fila->getFolio()."</td>";
															echo "<td>".$fila->getFecha()."</td>";
															echo "<td>".$fila->getNombre()."</td>";
															echo "<td>";
															echo "<button class='btn btn-outline-warning m-1' onclick='habilitarcomite(".$fila->getId().")'><i class='fa fa-check'></i></button>";
															echo "</td>";
															echo "</tr>";
														}
													?>
