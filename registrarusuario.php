...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Registrar Usuario</title>
...
<body class="main-body leftmenu">
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Registrar usuario</h1>
							<ol class="breadcrumb">
					...
					<div class="card">
						<div class="card-header bd-b-0">
							<h4 class="card-title font-weight-semibold mb-0">Registrar Usuario</h4>
						</div>
						<div class="card-body">
							<div class="message"></div>
							<form name="usuarioform" id="usuarioform" class="needs-validation was-validated">
								<div class="row">
									<div class="col-md-6 col-lg-6 ">
										<div class="form-group has-success mg-b-0">
											<label for="">RUT</label>
											<input name="UserRut" maxlength="12" minlength="9" autocapitalize="true" id="UserRut" type="text" onkeyup="formatRut(this)" placeholder="11.111.111-1" required class="form-control" />
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Nombres</label>
											<input type="text" autocapitalize="true" autocomplete="false" name="UserNombre" id="UserNombre" class="form-control" required placeholder="Ingrese el Nombre">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Apellido1</label>
											<input type="text" autocapitalize="true" autocomplete="false" class="form-control" name="UserApellido1" id="UserApellido1" required placeholder="Ingrese Primer Apellido">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Apellido2</label>
											<input type="text" autocapitalize="true" autocomplete="false" class="form-control" name="UserApellido2" id="UserApellido2" placeholder="Ingrese su Segundo">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Correo Electronico</label>
											<input type="email" autocapitalize="true" autocomplete="false" class="form-control" name="UserEmail" id="UserEmail" required placeholder="Ingrese el Correo Electronico">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Dirección</label>
											<input type="text" autocapitalize="true" autocomplete="false" class="form-control" name="UserDireccion" id="UserDireccion" required placeholder="Ingrese su Direccion">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Región</label>
											<select name="UserRegion" autocapitalize="true" id="UserRegion" onchange="listadocomunaregion(this)" required class="form-control regiones select2">
												<?php
									...
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											...
											<select name="UserComuna" autocapitalize="true" required id="UserComuna" class="form-control comunas select2">
									...
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											...
											<select name="Userprofesion" autocapitalize="true" required id="Userprofesion" class="form-control select2">
												<?php
												$lista = $c->listarprofesion();
												foreach ($lista as $object) {
													echo "<option value='" . $object->getId() . "'>" . $object->getNombre() . "</option>";
												}
									...
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Servicio de Proveniencia:</label>
											<select name="UserServicio" autocapitalize="true" required id="UserServicio" class="form-control select2">
												<?php
												$lista = $c->listarservicioproveniencia();
												foreach ($lista as $object) {
													echo "<option value='" . $object->getId() . "'>" . $object->getNombre() . "</option>";
												}
									...
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											...
											<input type="text" autocapitalize="true" autocomplete="false" class="form-control" required name="UserPhone" id="UserPhone" placeholder="Ingrese su numero de telefono">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Contraseña:</label>
											<input type="password" autocomplete="false" required placeholder="Ingrese su contraseña" name="UserPassword" id="UserPassword" class="form-control" minlength="4">
										</div>
									</div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group has-success mg-b-0">
											<label for="">Confirmar Contraseña:</label>
											<input type="password" autocomplete="false" required placeholder="Repite la contraseña" name="UserPassword1" id="UserPassword1" class="form-control" minlength="4">
										</div>
									<input type="hidden" id="idempresa" name="idempresa" value="<?php echo $empresa->getId();?>">
	...
	<script>
		...
		var input = document.getElementById("UserRut");
			...
			if (validarRut(rut)) {
				$.ajax({
					...
					success: function(data) {
						//Recibir el JSON desde PHP
						var datos = JSON.parse(data);
						//Validar si el error esta en false para poder continuar
						if (datos.error == false) {
							$(".message").html("<div class='alert alert-success'><strong><i class='fa fa-check-circle'></i></strong> " + datos.message + "</div>");
							$("#idusuario").val(datos.id);
							$("#UserNombre").val(datos.nombre);
							$("#UserApellido1").val(datos.apellido);
							$("#UserApellido2").val(datos.apellido2);
							$("#UserEmail").val(datos.email);
							$("#UserDireccion").val(datos.direccion);
							//Recorrer la region para seleccionar la que corresponde
							$("#UserRegion option").each(function() {
								if ($(this).val() == datos.region) {
									$(this).attr("selected", true);
									$("#select2-UserRegion-container").html($(this).text());
								}
							});
							listadocomunaregion1(datos.region);
							//Recorrer la comuna para seleccionar la que corresponde
							setTimeout(function() {
								$("#UserComuna option").each(function() {
									if ($(this).val() == datos.comuna) {
										$(this).attr("selected", true);
										$("#select2-UserComuna-container").html($(this).text());
									}
								});
							}, 1000);
							//Recorrer la profesion para seleccionar la que corresponde
							$("#Userprofesion option").each(function() {
								if ($(this).val() == datos.profesion) {
									$(this).attr("selected", true);
									$("#select2-Userprofesion-container").html($(this).text());
								}
							});
							//Recorrer el servicio para seleccionar la que corresponde
							$("#UserServicio option").each(function() {
								if ($(this).val() == datos.servicio) {
									$(this).attr("selected", true);
									$("#select2-UserServicio-container").html($(this).text());
								}
							});
							$("#UserPhone").val(datos.phone);
							$("#UserPassword").attr("disabled", true);
							$("#UserPassword").attr("required", false);
							$("#UserPassword").val(0);
							$("#UserPassword1").attr("disabled", true);
							$("#UserPassword1").attr("required", false);
							$("#UserPassword1").val(0);
						} else {
							$(".message").html("");
							$("#UserNombre").val("");
							...
							$("#UserPassword").val("");
							$("#UserPassword1").attr("disabled", false);
							$("#UserPassword1").val("");
						}
