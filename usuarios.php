                                        ...
                                        <tbody>
											<?php
												...
												foreach($lista as $r){
													...
													echo "</td>";
													echo "<td><a href='javascript:void(0)' onclick='resetear(".$id.")' class='btn btn-outline-success btn-sm' title='Resetear Contraseña'><i class='fa fa-key'></i></a></td>";
													echo "<td class='text-center'>";
													echo "<a href='editarusuario.php?code=".$id."' class='btn btn-outline-warning m-1 btn-sm' title='Editar Usuario'><i class='fa fa-edit'></i></a>";
													echo "<a href='roles.php?code=".$id."' class='btn btn-outline-info m-1 btn-sm' title='Roles'><i class='fa fa-user-tag'></i></a>";
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="staticBackdropLabel">Cambio de Contraseña <i class="fa fa-key"></i></h5>
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-12">
								...
								<input type="password" class="form-control" id="contra" placeholder="Ingrese la Nueva Contraseña">
							</div>
							<div class="col-md-12">
								<label for="">Confirmar la Contraseña</label>
								<input type="password" class="form-control" id="contra1" placeholder="Confirmar la Nueva Contraseña">
							</div>
							<div class="col-md-12 text-right">
								<button class="btn btn-primary mt-3" onclick="cambiarcontra()">Cambiar Contraseña</button>
							</div>
						</div>
					</div>
				</div>
