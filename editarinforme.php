	...
	<div class="page">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<?php $ultimoregistro = $c->ultimoregistropoblacional($idpaciente);?>
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
													...
													<div aria-labelledby="hospitalizacion" class="collapse" data-parent="#accordion" id="hospitalizaciones" role="tabpanel">
														...
														<div class="row">
																...
																<div class="col-md-12">
																	...
																	<textarea style="height: 100px;" name="observaciontnm" class="form-control" id="observaciontnm" cols="10" rows="10"><?php echo $informe->getObservacionTnm();?></textarea>
																</div>
															</div>
														</div>
													</div>
																			...
																			<div class="row">
																				<div class="col-md-12">
																					<div class="card-body">
																						...
																						<input type="hidden" id="pacientepoblacional" name="pacientepoblacional" value="<?php echo $idpaciente; ?>">
