...
create table borradorinformecomite(
    ...
    diagnosticotext text null,
    diagnosticocie10 text null,
    diagnosticocie10text text null,
    fechabiopsia date null,
    reingreso int null,
    ecog int null references ecog(id),
    histologico int null references histologico(id),
    invaciontumoral int null references invaciontumoral(id),
    mitotico int null,
    observaciontnm text null,
    anamesis text  null,
    cirugia int null default 0,
    quimioterapia int  null default 0,
    radioterapia int  null default 0,
    ...
    estudioclinico int null default 0,
    observaciondesicion text  null,
    consultade text null,
    consultadeid int null,
    programacionquirurgica int null default 0,
    traslado int null default 0,
    ciudadospaliativos int null default 0,
    ingresohospitalario int null default 0,
...
create table tnmborradorinformecomite(
    id int not null auto_increment primary key,
    borradorinformecomite int not null references borradorinformecomite(id),
    t1 text null,
    t int not null references tnm(id),
    ttexto text null,
    n int not null references tnm(id),
