				...
				<div class="inner-body">
                    ...
                    <div class="card">
                        <div class="card-header bd-b-0">
                            <h4 class="card-title font-weight-semibold mb-0">Accion: <?php echo $object1->getNombre();?></h4>
                        </div>
                        <div class="card-body">
                            <div class="">
                                    ...
                                    <table class="table w-100 text-nowrap" id="example1">
                                        <thead class="border-top">
                                            <tr class="text-center">
                                                ...
                                                <th class="bg-transparent">Titulo</th>
                                        ...
                                        <tbody>
											<?php
												$lista = $c->listarAuditoriaAccion($object1->getId(), $empresa->getId());
												foreach($lista as $r){
													echo "<tr class='text-center'>";
													echo "<td>".$r->getUsuario()."</td>";
													echo "<td>".$r->getAccion()."</td>";
													echo "<td>".$r->getTitulo()."</td>";
													echo "<td>".date("d-m-Y H:i:s", strtotime($r->getFecha()))."</td>";
													echo "<td class='text-center'>";
														echo "<button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#modaledit' onclick='mostrar(".$r->getId().")'><i class='fa fa-eye'></i></button>";
													echo "</td>";
													echo "</tr>";
												}
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="staticBackdropLabel">Detalle Evento</h5>
