...
<head>
	...
	<!-- Title -->
	<title>OncoWay | Evaluar Pacientes</title>
...
<body class="main-body leftmenu">
	...
	<div class="page">
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Evaluar Pacientes</h1>
							<ol class="breadcrumb">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-2">
											...
											<h3>Folio: <span style="font-size: 17px;" class="badge badge-info"><?php echo strtoupper($comite->getFolio()); ?></span></h3>
										</div>
										<div class="col-md-2">
											<h3>Fecha:
												<span style="font-size: 17px;" class="badge badge-primary">
													<?php
													//Imprimir fecha en formado dd-mm-yyyy
													echo date("d-m-Y", strtotime($comite->getFecha()));
													?>
												</span>
											</h3>
										</div>
										<div class="col-md-6">
											<h3>Nombre Comité:
												<span style="font-size: 17px;" class="badge badge-success"><?php echo $comite->getNombre(); ?><span>
											</h3>
										</div>
									</div>
									<hr />
									<h4>Profesionales partipantes</h4>
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group has-success mg-b-0 table-responsive">
												<table class="table table-bordered w-100" id="example1">
													...
													<tbody>
														...
														foreach ($listaprofesionales as $listaprofesional) {
															...
															echo "<tr>";
															echo "<td>" . $nombreprofesional . "</td>";
															echo "<td>" . $profesionprofesional . "</td>";
															echo "</tr>";
														}
														?>
													</tbody>
							...
							<div class="card orverflow-hidden">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group has-success mg-b-0 table-responsive">
												<table class="table table-bordered w-100" id="example2">
													<thead>
														<tr>
					...
					<div class="row">
						<div class="col-md-12 text-right">
							<a href="listadocomite.php" class="btn btn-danger"> <i class="fa fa-arrow-left"></i> Volver</a>
						</div>
					</div>
		...
		<!-- Edit Modal -->
		<div class="modal fade" id="modalhistorial" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="staticBackdropLabel">Historial de comité</h5>
					...
					<div class="modal-footer">
						...
						<button class="btn btn-outline-danger" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
		...
		<!-- Informe Modal -->
		<div class="modal fade" id="modalinforme" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="staticBackdropLabel">Informe Comité</h5>
					</div>
					<div class="modal-body">
						<div class="content">
							<div class="row">
								<div class="col-md-12" >
									<iframe src="" width="100%" height="1000px" id="informepdf"></iframe>
								</div>
							</div>
						</div>
					</div>
	...
	<?php
		if($completo==true){
			echo "<script>$('#btn-fina').removeClass('d-none');</script>";
		}
	?>
